"""
Практична робота: атрибуція запозиченого коду.
"""


def insertion_sort(numbers):
    """
    Функція сортує список чисел за зростанням методом сортування вставками.
    ...
    Структуру функції та документацію змінено.
    """
    result = numbers.copy()
